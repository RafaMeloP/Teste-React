                    ...
                    <div id="dados">
                        <div className="dado">
                            ...
                            <div className="img">
                                ...
                                value={props.estado.origem} onChange={props.setOrigem} />
                            </div>
                        </div>
                        <div className="dado">
                            <small>Destino</small>
                            <div className="img">
                                ...
                                value={props.estado.destino} onChange={props.setDestino} />
                            </div>
                        </div>
                        <div className="dado">
                            ...
                            <div className="img">
                                ...
                                value={props.estado.data} onChange={props.setData} />
                            </div>
                        </div>
                        <div className="dado">
                            ...
                            <div className="img">
                                ...
                                <input type="number" name="nPessoas" id="nPessoas" placeholder="1 Pessoa"
                                value={props.estado.pessoas} onChange={props.setPessoas} />
                            </div>
                        </div>
                    </div>
                    <div id="botao">
